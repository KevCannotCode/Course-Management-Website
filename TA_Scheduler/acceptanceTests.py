...
class myCourseInstructor(TestCase):
    ...
    def test_good_assign(self):
        resp = self.client.post("/myCourseInstructor/", {"Instructor Name": self.myCourseInstructor.instructorUserName,
                                                         "CourseNumber": self.myCourseInstructor.courseNumber})
        self.assertEquals(resp.context["message"], "Course Assigned", "assigning instructor to course failed."
